...
- Movement: WASD/arrows (8-way), `b` = back up without turning, `f` = descend stairs, `r` = read scroll. Player speed 0.25 px/frame at a fixed 60 Hz (15 px/s — traversal is deliberately slow).
